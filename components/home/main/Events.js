...
const Events = () => {
  ...
  return (
    <section
      id='events'
      className='flex w-full flex-col items-center pb-[7.75rem] pt-20 md:py-[7.5rem]'
    >
      <div className='flex w-[87.2%] flex-col items-center gap-12 md:w-[89.71%] md:gap-14'>
        ...
        <div className='hidden h-[360px] w-[573px] shadow-[0_100px_75px_-50px_rgba(56,66,85,0.5032)] drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)] md:relative md:block'>
          <Image
            width={573}
            height={360}
            src={
        ...
        <div className='flex w-full flex-col items-center gap-6 md:gap-10'>
          <div className=' flex w-full flex-col items-center gap-4 md:flex-row md:gap-[0.625rem]'>
            <button
              className={`${
                selected === 0 && 'selected'
              } font-h3-s relative flex w-full items-center justify-center uppercase text-[#4c4c4c]/50 md:pb-2`}
              type='button'
          ...
          <div className='flex flex-col items-center gap-8 md:w-[66.33%]'>
