...
const Events = () => {
  ...
  return (
    <section
      id="events"
      className="mb-[7.75rem] flex w-[20.438rem] flex-col items-center md:relative md:mb-[7.5rem] md:w-[43.063rem]"
    >
      <div className="mb-12 w-full shadow-[0px_75px_100px_-50px_rgba(56,66,85,0.5032)] md:mb-14 md:w-[35.813rem]">
        <img
          className="md:hidden"
          src={
            selected === 1
      ...
      <div className="mb-6 flex w-full flex-col items-center gap-4 md:mb-10 md:flex-row md:gap-[0.625rem]">
        <button
      ...
      <div className="mb-8 flex w-full flex-col items-center gap-4 text-center md:w-[28.563rem]">
